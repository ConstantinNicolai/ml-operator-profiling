...
string = "../functional_general_benchmark/datasets_train/dataset_history_" + path
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/train/ops/runtime_plot_'+path+'.png', format='png')
plt.savefig('plots/train/ops/runtime_plot_'+path+'.pdf', format='pdf')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/train/ops/power_plot_'+path+'.png', format='png')
plt.savefig('plots/train/ops/power_plot_'+path+'.pdf', format='pdf')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/train/ops/energy_plot_'+path+'.png', format='png')
plt.savefig('plots/train/ops/energy_plot_'+path+'.pdf', format='pdf')
plt.close()
...
joblib.dump(runtime_model, 'model_dump/train/runtime_model_'+path+'.pkl')
joblib.dump(wattage_model, 'model_dump/train/wattage_model_'+path+'.pkl')
