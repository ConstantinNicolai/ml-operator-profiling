...
plt.legend()
plt.tight_layout()
plt.savefig('plots/inf/ops/runtime_plot_'+path+'.png', format='png')
plt.savefig('plots/inf/ops/runtime_plot_'+path+'.pdf', format='pdf')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/inf/ops/power_plot_'+path+'.png', format='png')
plt.savefig('plots/inf/ops/power_plot_'+path+'.pdf', format='pdf')
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('plots/inf/ops/energy_plot_'+path+'.png', format='png')
plt.savefig('plots/inf/ops/energy_plot_'+path+'.pdf', format='pdf')
plt.close()
...
joblib.dump(runtime_model, 'model_dump/inf/runtime_model_'+path+'.pkl')
joblib.dump(wattage_model, 'model_dump/inf/wattage_model_'+path+'.pkl')
