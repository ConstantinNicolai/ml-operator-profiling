...
threshold = 8000  # Example threshold, you can change this
...
if small_indices:
    ...
    bar2 = ax.bar(index + bar_width, small_predicted, bar_width, label='Predicted', color=maroon_color)
...
if large_indices:
    ...
    bar2 = ax.bar(index + bar_width, large_predicted, bar_width, label='Predicted', color=maroon_color)
