    ...
    if done == False:
        ...
        if list_attemps:
            ...
            for h in range(number_of_unique_operators_in_model):
                ...
                iterations, time_difference_seconds, time_per_iteration, filtered_mean_value2, std_value2, total_energy_joules, energy_per_iteration_in_milli_joule = process_log_file('current_temp_A30.log', required_iterations)
