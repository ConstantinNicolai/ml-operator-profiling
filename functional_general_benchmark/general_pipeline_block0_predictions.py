...
for summary_file in glob.glob('./../predictions/*/*/summary.yml'):
...
# with open('./../predictions/resnet18_32,3,224,224/summary.yml', 'r') as file:
#     config = yaml.safe_load(file)
...
# with lzma.open('./../predictions/resnet18_32,3,224,224/' + filename, "wb") as file_:
#     pickle.dump(opus_magnum_dict, file_)
